...
import './App.css';
import abhiImage from "./prasanna.jpg"; 
    ...
    <div className="App">
      <header>
        <div className="user">
          ...
          <h3 className="name">Lakshmi Prasanna</h3>
        </div>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Lakshmi Prasanna </h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Kadapa</h3>
            <h3> <span> Strengths : </span> Honesty, Patience, Dedication, Smartwork </h3>
            <h3> <span> Hobbies: </span> Spending time in home</h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>Z.P Girls High School,Kadapa</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> kaluvalakshmiprasanna@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9014897440  </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> kadapa </h3>
            </div>
          </div>
        </div>
      </section>
